...
Naming convention for articles should follow:
...
<journal of publishing>_<volume>_<issue>-pp_<page start>_<page end>-<year published>-<author(s) last names separated by underscores (can limit to two/three)>-fig_<figure number major>_<figure number minor (if applicable)>

Naming convention for tables should follow:
<journal of publishing>_<volume>_<issue>-pp_<page start>_<page end>-<year published>-<author(s) last names separated by underscores (can limit to two/three)>-tab_<table number major>_<table number minor (if applicable)>

Note: Any and all spaces in the filename should be replaced by underscores.